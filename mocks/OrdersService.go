...
func (_m *OrdersService) GetOrder(ctx context.Context, userId int, id int) mo.Result[models.Order] {
	ret := _m.Called(ctx, userId, id)

	var r0 mo.Result[models.Order]
	if rf, ok := ret.Get(0).(func(context.Context, int, int) mo.Result[models.Order]); ok {
		r0 = rf(ctx, userId, id)
	} else {
		r0 = ret.Get(0).(mo.Result[models.Order])
	}
