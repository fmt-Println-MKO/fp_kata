...
func (_m *OrdersDatasource) GetAllOrdersForUser(ctx context.Context, userID int) monads.Result[[]dsmodels.Order] {
	ret := _m.Called(ctx, userID)

	var r0 monads.Result[[]dsmodels.Order]
	if rf, ok := ret.Get(0).(func(context.Context, int) monads.Result[[]dsmodels.Order]); ok {
		r0 = rf(ctx, userID)
	} else {
		r0 = ret.Get(0).(monads.Result[[]dsmodels.Order])
	}
...
func (_m *OrdersDatasource) GetOrder(ctx context.Context, orderID int) monads.Result[dsmodels.Order] {
	ret := _m.Called(ctx, orderID)
...
func (_m *OrdersDatasource) InsertOrder(ctx context.Context, order dsmodels.Order) monads.Result[dsmodels.Order] {
	ret := _m.Called(ctx, order)

	var r0 monads.Result[dsmodels.Order]
	if rf, ok := ret.Get(0).(func(context.Context, dsmodels.Order) monads.Result[dsmodels.Order]); ok {
		r0 = rf(ctx, order)
	} else {
		r0 = ret.Get(0).(monads.Result[dsmodels.Order])
	}
...
func (_m *OrdersDatasource) UpdateOrder(ctx context.Context, order dsmodels.Order) monads.Result[dsmodels.Order] {
	ret := _m.Called(ctx, order)
